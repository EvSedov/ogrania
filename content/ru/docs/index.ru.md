...
5. [{{< svg "pdf_icon.svg" >}} Приказ об утверждении режима занятий обучающихся](./files/Режим%20занятий%20обучающихся.pdf) ([{{< svg "sig_doc_icon.svg" >}} файл с ЭЦП документа](./files/Режим%20занятий%20обучающихся.pdf.p7s)
